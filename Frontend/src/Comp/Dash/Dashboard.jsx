...
import { Shield, Wifi, AlertTriangle, Activity, Users, Lock, TrendingUp, TrendingDown } from "lucide-react"
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#0e0e0f] text-white">
      {/* Header */}
      <div className="bg-[#1a1a1c] border-b border-[#2e2e30] px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Shield className="w-8 h-8 text-[#fd594e]" />
            <div>
              <h1 className="text-xl font-bold">Shakti Dashboard</h1>
              <p className="text-sm text-[#b0b0b0]">WiFi Network Monitoring</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
              <span className="text-sm text-[#b0b0b0]">Live Monitoring</span>
            </div>
            <div className="text-sm text-[#b0b0b0]">Last Updated: {new Date().toLocaleTimeString()}</div>
          </div>
        </div>
      </div>
